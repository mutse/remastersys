...
class appgui:
    def __init__(self):
        ...
        self.gladefile = "/usr/share/remastersys-gtk/ui/remastersys-gtk.glade"
...
if os.popen('whoami').read().strip() != 'root':
    ...
    if os.system('which gksu')==0:
        if os.path.exists('/usr/share/applications/remastersys-gtk.desktop'):
            os.system('gksu -D "%s" python ./remastersys_gtk.py' % _('Remastersys'))
        else:
            os.system('gksu -D "%s" python ./remastersys_gtk.py' % '/usr/share/applications/remastersys-gtk.desktop')
    elif os.system('which kdesudo')==0:
        os.system('kdesudo ./remastersys_gtk.py' )
    elif os.system('which sudo')==0:
        password = msg_input(_(''), _('Enter your password to perform administrative tasks'), 'Password:', '', None, True)
        if password:
            os.popen('sudo -S python ./remastersys_gtk.py','w').write(password)
else:
